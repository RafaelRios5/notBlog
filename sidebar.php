<div class="sidebar">
    ...
    while ($rowData = $sidebar->fetch()) {
        echo ' <a href="http://localhost/blog/' . $rowData['articleSlug'] . '" >' . $rowData['articleTitle'] . ' </a >';
    }
    ?>
    ...
    while ($rowData = $stmt->fetch()) {
        echo '<a href="http://localhost/blog/category/' . $rowData['categorySlug'] . '">' . $rowData['categoryName'] . '</a>';
    }
    ?>
